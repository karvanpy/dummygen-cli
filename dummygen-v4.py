...
import shutil  # For disk space information
...
def generate_dummy_file(filename: str, size: float, unit: str) -> None:
    """Generates a dummy file of the specified size."""
    ...
    try:
        ...
        console.print(f"[bold green]Dummy file '{filename}' ({size} {unit}) generated successfully![/]")
...
def main():
    ...
    generate_dummy_file(filename, size, unit)
